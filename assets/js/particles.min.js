        ...
        function t(a, t, n, s, r) {
            if (a != t)
                if (i.tmp.bubble_duration_end)
                    null != n && (o = a + (a - (s - p * (s - a) / i.interactivity.modes.bubble.duration)), "size" == r && (e.radius_bubble = o), "opacity" == r && (e.opacity_bubble = o));
    ...
    i.fn.vendors.eventsListeners = function () {
        ...
        (i.interactivity.events.onhover.enable || i.interactivity.events.onclick.enable) && (i.interactivity.el.addEventListener("mousemove", (function (e) {
                    if (i.interactivity.el == window)
                        ...
                        a = e.offsetX || e.clientX, t = e.offsetY || e.clientY;
        ...
        if (i.tmp.img_error = void 0, "" != i.particles.shape.image.src)
            if ("svg" == e) {
                ...
                a.onreadystatechange = function (e) {
                    4 == a.readyState && (200 == a.status ? (i.tmp.source_svg = e.currentTarget.response, i.fn.vendors.checkBeforeDraw()) : i.tmp.img_error = !0)
                },
                a.send()
            } else {
                var t = new Image;
